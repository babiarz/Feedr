...
**Note:** You can find the starter code [here](https://github.com/gordonkristan/project-2-starter-code).
...
contained in the provided [index.html](https://github.com/gordonkristan/project-2-starter-code/blob/master/index.html) file. Our task, after we pull from the
